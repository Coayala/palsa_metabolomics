...
figure_3 <- pls_da_plot$graph + loadings +
  plot_annotation(tag_levels = 'A') &
  theme(plot.tag = element_text(size = 20))

figure_3

figure_file <- file.path(figures_dir, 'Figure3.png')
ggsave(figure_file, figure_3, dpi = 300, width = 10)
```
...
figure_file <- file.path(figures_dir, 'Figure2.png')
...
label_status_color <- set_names(c(get_palette('Set1', 3), 'gray'),
